(function(){
  ...
  // Back button
  document.getElementById('back-to-master').addEventListener('click', () => {
    window.location.href = `/webapp-master/master.html?mid=${encodeURIComponent(masterTelegramId)}`;
  });
      ...
      data.expenses.forEach(expense => {
        ...
        div.innerHTML = `
          ...
          <div class="expense-actions">
            <button class="btn-icon btn-edit" data-id="${expense.id}">✏️</button>
            <button class="btn-icon btn-delete" data-id="${expense.id}">🗑️</button>
          </div>
        `;
