...
SUBSCRIPTION_PLANS = {
    ...
    SubscriptionPlan.MONTHLY: PlanConfig(
        ...
        duration_days=30,
        price_rub=990,
        price_stars=490,  # 990₽ ≈ 490 звёзд (курс ~2₽/⭐)
        features=[
            "✅ Все функции бота",
            "✅ Неограниченное количество записей",
            "✅ Напоминания клиентам",
    ...
    SubscriptionPlan.QUARTERLY: PlanConfig(
        ...
        duration_days=90,
        price_rub=2490,  # ~830₽/мес
        price_stars=1230,  # 2490₽ ≈ 1230⭐ (экономия 16%)
        features=[
            "✅ Все функции бота",
            "✅ Неограниченное количество записей",
            "✅ Напоминания клиентам",
    ...
    SubscriptionPlan.YEARLY: PlanConfig(
        ...
        duration_days=365,
        price_rub=8280,  # ~690₽/мес
        price_stars=4090,  # 8280₽ ≈ 4090⭐ (экономия 30%)
        features=[
            "✅ Все функции бота",
            "✅ Неограниченное количество записей",
            "✅ Напоминания клиентам",
